...
<body class="fix-header">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper" style="height:1200px;">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="fname" class="form-control form-control-danger"  value="<?php  echo $newrow['f_name'];  ?>" placeholder="tom">
                                                    </div>
                                            </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="lname" class="form-control" placeholder="david"  value="<?php  echo $newrow['l_name']; ?>">
                                                   </div>
                                            </div>
            ...
            <footer class="footer"> © 2024 - Café ZARZA Online Food Ordering System </footer>
