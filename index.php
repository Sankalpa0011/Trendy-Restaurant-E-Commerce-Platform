...
<body class="home">
    ...
    <script>
        ...
        <section class="hero bg-image" data-image-src="images/img/pimg.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h style="font-family: 'Poppins', sans-serif; font-size: 60px;">CAFÉ ZARZA</h><br><br>
                    <h1>Order Delivery & Take-Out / Dine-In </h1>
        ...
        <section>
            <center><h2>❄️❄️❄️❄️❄️❄️❄️❄️❄️❄️❄️❄️❄️❄️❄️❄️</h2>
            <h2>Discover festive discounts at Café Zarza!</h2>
            <p class="lead">Indulge in our exclusive Christmas dine-in offer! Enjoy delightful seasonal dishes and discounts, making your celebrations unforgettable.</p>
            <h2>🦌🦌🦌☃️☃️🎄🎄🎅🎅🎅🎅🎅🎄🎄☃️☃️🦌🦌🦌</h2></center><br>

            <div class="food-item-wrap">
                <!-- First Image -->
                <img src="images/img/uyt.jpg" alt="Advertisement 1" style="width: 49.85%; max-height: 320px;  ">
                
                <!-- Second Image -->
                <img src="images/img/wer.jpg" alt="Advertisement 2" style="width: 49.85%; max-height: 450px; ">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with menus from a variety of our delivery restaurants online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose a dish</h3>
                                <p>We"ve got your covered with a variety of our delivery restaurants online.</p>
                            </div>
                        </div>
        ...
        <section class="featured-restaurants">
            ...
            <section class="map" id="footer">
                <div class="container">
                    <h4 class="text-center">Find us!</h4><br>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3957.5477821168424!2d80.6343656748391!3d7.292179192715331!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae3662be0c2cc7f%3A0xfd9ffe3da66f497!2sKandy%20City%20Centre%2C%20Sri%20Dalada%20Veediya%2C%20Kandy%2020000!5e0!3m2!1sen!2slk!4v1702199031865!5m2!1sen!2slk" style= "width:100%;  height:250px; border:0;" allowfullscreen></iframe>
                        <div class="row staff">
        ...
        <footer class="footer">
            <div class="container">
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Café Zarza<br>5<sup>th</sup> floor, No: 05, Sri Dalada Weediya, KCC, Kandy</p>
                                    <h5>Phone: +94 110987654</a></h5> </div>
                ...
                <br><center><p>© 2024 - Café ZARZA Online Food Ordering System </p></center>
        </footer>
